  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-md rounded">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        />
        {errors.student_id && <div className="text-red-500">{errors.student_id}</div>}
        ...
        <input
          ...
          className="w-full p-2 border rounded"
        />
        {errors.first_surname && <div className="text-red-500">{errors.first_surname}</div>}
        ...
        <input
          ...
          className="w-full p-2 border rounded"
        />
        {errors.second_surname && <div className="text-red-500">{errors.second_surname}</div>}
        ...
        {errors.major && <div className="text-red-500">{errors.major}</div>}
